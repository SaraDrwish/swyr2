    ...
    <section ref={containerRef} className="py-20 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Vertical line */}
          <motion.div
            className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-orange-500/30"
            style={{ scaleY: scaleX }}
          />
...
function TimelineEvent({
  ...
  return (
    ...
    >
      ...
      <div className="z-20">
        <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-blue-900 to-orange-500 rounded-full">
      ...
      <motion.div
        ...
        onClick={onToggle}
      >
        <div className="p-4 bg-background rounded-lg shadow-md border border-orange-500/20">
